...
export function IconMaps({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
...
export function IconViber({ className = "h-5 w-5" }: { className?: string }) {
  return (
...
export function IconPhone({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
        d="M7.5 3.8h3.2l1.2 4.2-2 1.2a12.5 12.5 0 0 0 5 5l1.2-2 4.2 1.2v3.2c0 .9-.7 1.6-1.6 1.6A14.7 14.7 0 0 1 4.2 5.4c0-.9.7-1.6 1.6-1.6Z"
        stroke="currentColor"
        strokeWidth="1.7"
...
export function FlagSr({ className = "h-4 w-6" }: { className?: string }) {
  return (
    <img
      src="/brand/flag-rs.svg"
      alt=""
      aria-hidden="true"
